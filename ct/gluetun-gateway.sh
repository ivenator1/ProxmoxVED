...
echo -e "${INFO}${YW} Edit the config (also linked as ~/config.env), then restart the service:${CL}"
echo -e "${TAB}${GATEWAY}${BGN}/etc/gluetun/gluetun.env${CL}"
echo -e "${INFO}${YW} Forwarded-port API:${CL}"
